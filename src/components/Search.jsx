    ...
    return (
      <div className="master">
        <header className="App-header">
            ...
            { showDropdown && (<div className="dropdown-content">{listOfShips}</div>)}   
        </header>
        <div className="display-ships">{displayShips.map((i) => <Ship name={i.name} model={i.model} class={i.starship_class} crew={i.crew} />)}</div>
